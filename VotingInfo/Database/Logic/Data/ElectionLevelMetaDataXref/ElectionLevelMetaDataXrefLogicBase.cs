...
{
	[Serializable]
	public abstract partial class ElectionLevelMetaDataXrefLogicBase : LogicBase<ElectionLevelMetaDataXrefLogicBase>
	{
		//Put your code in a separate file.  This is auto generated.
    
		[XmlArray] public List<ElectionLevelMetaDataXrefContract> Results;

		public ElectionLevelMetaDataXrefLogicBase()
		{
			Results =  new List<ElectionLevelMetaDataXrefContract>();
		}
...
, string fldMetaDataId
)
		{
			...
			{
				using (
					var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_Insert]", x)
					{
...
, SqlConnection connection, SqlTransaction transaction)
		{
			using (
				var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_Insert]", connection)
...
,
		...
		public int Insert(ElectionLevelMetaDataXrefContract row)
		{
			int? result = null;
			VotingInfoDb.ConnectThen(x =>
			{
...
,
					...
					result = (int?)cmd.ExecuteScalar();
					row.ElectionLevelMetaDataXrefId = result;
				}
			});
		...
		/// <param name="transaction">The SqlTransaction to use</param>
		/// <returns>1, if insert was successful</returns>
		public int Insert(ElectionLevelMetaDataXrefContract row, SqlConnection connection, SqlTransaction transaction)
		{
			int? result = null;
			using (
				var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_Insert]", connection)
...
,
		...
		public virtual int InsertAll(List<ElectionLevelMetaDataXrefContract> rows)
		{		
			var rowCount = 0;
			VotingInfoDb.ConnectThen(x => 
			{
		...
		/// <param name="transaction">The SqlTransaction to use</param>
		/// <returns>The number of rows affected.</returns>
		public virtual int InsertAll(List<ElectionLevelMetaDataXrefContract> rows, SqlConnection connection, SqlTransaction transaction)
		{
			var rowCount = 0;
		...
		/// <param name="fldElectionLevelId">Value for ElectionLevelId</param>
		/// <param name="fldMetaDataId">Value for MetaDataId</param>
		public virtual int Update(int fldElectionLevelMetaDataXrefId
...
, string fldMetaDataId
)
		{
			...
			{
				using (
					var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_Update]", x)
					{
						CommandType = CommandType.StoredProcedure,
						CommandTimeout = DefaultCommandTimeout
					})
				{
					cmd.Parameters.AddRange(new[] {
						new SqlParameter("@ElectionLevelMetaDataXrefId", fldElectionLevelMetaDataXrefId)
,
						new SqlParameter("@ContentInspectionId", fldContentInspectionId)
,
						new SqlParameter("@ElectionLevelId", fldElectionLevelId)
...
, SqlConnection connection, SqlTransaction transaction)
		{
			var rowCount = 0;
			using (
				var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_Update]", connection)
				{CommandType = CommandType.StoredProcedure,Transaction = transaction})
			{
					cmd.Parameters.AddRange(new[] {
						new SqlParameter("@ElectionLevelMetaDataXrefId", fldElectionLevelMetaDataXrefId)
...
,
		...
		/// <param name="row">The table row data to use</param>
		/// <returns>The number of rows affected.</returns>
		public virtual int Update(ElectionLevelMetaDataXrefContract row)
		{
			var rowCount = 0;
			VotingInfoDb.ConnectThen(x =>
			{
				...
				{
					cmd.Parameters.AddRange(new[] {
						new SqlParameter("@ElectionLevelMetaDataXrefId", row.ElectionLevelMetaDataXrefId)
,
						new SqlParameter("@ContentInspectionId", row.ContentInspectionId)
,
						new SqlParameter("@ElectionLevelId", row.ElectionLevelId)
,
		...
		/// <param name="transaction">The SqlTransaction to use</param>
		/// <returns>The number of rows affected.</returns>
		public virtual int Update(ElectionLevelMetaDataXrefContract row, SqlConnection connection, SqlTransaction transaction)
		{
			var rowCount = 0;
			using (
				var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_Update]", connection)
...
,
		...
		/// <returns>The number of rows affected.</returns>
		public virtual int UpdateAll(List<ElectionLevelMetaDataXrefContract> rows)
		{		
			var rowCount = 0;
			VotingInfoDb.ConnectThen(x => 
			{
		...
		/// <param name="transaction">The SqlTransaction to use</param>
		/// <returns>The number of rows affected.</returns>
		public virtual int UpdateAll(List<ElectionLevelMetaDataXrefContract> rows, SqlConnection connection, SqlTransaction transaction)
		{
			var rowCount = 0;
		...
		/// <returns>The number of rows affected.</returns>
		/// <param name="fldElectionLevelMetaDataXrefId">Value for ElectionLevelMetaDataXrefId</param>
		public virtual int Delete(int fldElectionLevelMetaDataXrefId
)
		{
			var rowCount = 0;
			VotingInfoDb.ConnectThen(x =>
			{
				using (
					var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_Delete]", x)
					{
						CommandType = CommandType.StoredProcedure,
						CommandTimeout = DefaultCommandTimeout
					})
...
, SqlConnection connection, SqlTransaction transaction)
		{
			var rowCount = 0;
			using (
				var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_Delete]", connection)
				{CommandType = CommandType.StoredProcedure,Transaction = transaction})
			{
					cmd.Parameters.AddRange(new[] {
						new SqlParameter("@ElectionLevelMetaDataXrefId", fldElectionLevelMetaDataXrefId)
		...
		/// <param name="row">The table row data to use</param>
		/// <returns>The number of rows affected.</returns>
		public virtual int Delete(ElectionLevelMetaDataXrefContract row)
		{
			var rowCount = 0;
			VotingInfoDb.ConnectThen(x =>
			{
		...
		/// <param name="transaction">The SqlTransaction to use</param>
		/// <returns>The number of rows affected.</returns>
		public virtual int Delete(ElectionLevelMetaDataXrefContract row, SqlConnection connection, SqlTransaction transaction)
		{
			var rowCount = 0;
			using (
				var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_Delete]", connection)
		...
		/// <returns>The number of rows affected.</returns>
		public virtual int DeleteAll(List<ElectionLevelMetaDataXrefContract> rows)
		{		
			var rowCount = 0;
			VotingInfoDb.ConnectThen(x => 
			{
		...
		/// <param name="transaction">The SqlTransaction to use</param>
		/// <returns>The number of rows affected.</returns>
		public virtual int DeleteAll(List<ElectionLevelMetaDataXrefContract> rows, SqlConnection connection, SqlTransaction transaction)
		{
			var rowCount = 0;
		...
		public virtual bool Exists(int fldElectionLevelMetaDataXrefId
)
		{
			bool result = false;
			...
			{
				using (
					var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_Exists]", x)
					{
						CommandType = CommandType.StoredProcedure,
						CommandTimeout = DefaultCommandTimeout
					})
...
, SqlConnection connection, SqlTransaction transaction)
		{					
			using (
				var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_Exists]", connection)
				{CommandType = CommandType.StoredProcedure,Transaction = transaction})
			{
					cmd.Parameters.AddRange(new[] {
						new SqlParameter("@ElectionLevelMetaDataXrefId", fldElectionLevelMetaDataXrefId)
		...
		public virtual bool Search(string fldMetaDataId
)
		{
			var result = false;
			...
			{
				using (
					var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_Search]", x)
					{
						CommandType = CommandType.StoredProcedure,
						CommandTimeout = DefaultCommandTimeout
					})
...
, SqlConnection connection, SqlTransaction transaction)
		{
			using (
				var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_Search]", connection)
				{CommandType = CommandType.StoredProcedure,Transaction = transaction})
			{
					cmd.Parameters.AddRange(new[] {
						new SqlParameter("@MetaDataId", fldMetaDataId)
		...
		public virtual bool SelectAll()
		{
			...
			{
				using (
					var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_SelectAll]", x)
					{
						CommandType = CommandType.StoredProcedure,
						CommandTimeout = DefaultCommandTimeout
					})
		...
		{
			using (
				var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_SelectAll]", connection)
				{CommandType = CommandType.StoredProcedure,Transaction = transaction})
			{
				using(var r = cmd.ExecuteReader()) return ReadAll(r);
			}
		...
		/// <param name="fldElectionLevelMetaDataXrefId">Value for ElectionLevelMetaDataXrefId</param>
		/// <returns>A collection of ElectionLevelMetaDataXrefRow.</returns>
		public virtual bool SelectBy_ElectionLevelMetaDataXrefId(int fldElectionLevelMetaDataXrefId
)
		{
			var result = false;
			...
			{
				using (
					var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_SelectBy_ElectionLevelMetaDataXrefId]", x)
					{
						CommandType = CommandType.StoredProcedure,
						CommandTimeout = DefaultCommandTimeout
					})
...
, SqlConnection connection, SqlTransaction transaction)
		{
			using (
				var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_SelectBy_ElectionLevelMetaDataXrefId]", connection)
				{CommandType = CommandType.StoredProcedure,Transaction = transaction})
			{
					cmd.Parameters.AddRange(new[] {
						new SqlParameter("@ElectionLevelMetaDataXrefId", fldElectionLevelMetaDataXrefId)
		...
		/// <param name="fldMetaDataId">Value for MetaDataId</param>
		/// <returns>A collection of ElectionLevelMetaDataXrefRow.</returns>
		public virtual bool SelectBy_MetaDataId(string fldMetaDataId
)
		{
			var result = false;
			...
			{
				using (
					var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_SelectBy_MetaDataId]", x)
					{
						CommandType = CommandType.StoredProcedure,
						CommandTimeout = DefaultCommandTimeout
					})
...
, SqlConnection connection, SqlTransaction transaction)
		{
			using (
				var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_SelectBy_MetaDataId]", connection)
				{CommandType = CommandType.StoredProcedure,Transaction = transaction})
			{
					cmd.Parameters.AddRange(new[] {
						new SqlParameter("@MetaDataId", fldMetaDataId)
...
, SqlConnection connection, SqlTransaction transaction)
...
)
		{
			...
			{
				using (
					var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_SelectBy_ContentInspectionId]", x)
					{
						CommandType = CommandType.StoredProcedure,
						CommandTimeout = DefaultCommandTimeout
					})
...
, SqlConnection connection, SqlTransaction transaction)
		{
			using (
				var cmd = new SqlCommand("[Data].[ElectionLevelMetaDataXref_SelectBy_ContentInspectionId]", connection)
				{CommandType = CommandType.StoredProcedure,Transaction = transaction})
			{
					cmd.Parameters.AddRange(new[] {
						new SqlParameter("@ContentInspectionId", fldContentInspectionId)
		...
		public virtual bool ReadOne(SqlDataReader reader)
		{
			...
			{
				Results.Add(
					new ElectionLevelMetaDataXrefContract
					{
					ElectionLevelMetaDataXrefId = reader.GetInt32(0),
					ContentInspectionId = reader.GetInt32(1),
					ElectionLevelId = reader.GetInt32(2),
					MetaDataId = reader.IsDBNull(3) ? null : reader.GetString(3),
		...
		/// <returns>The number of rows affected.</returns>
		public virtual int Save(ElectionLevelMetaDataXrefContract row)
		{
			if(row == null) return 0;
			if(row.ElectionLevelMetaDataXrefId != null) return Update(row);
		...
		/// <param name="transaction">The SqlTransaction to use</param>
		/// <returns>The number of rows affected.</returns>
		public virtual int Save(ElectionLevelMetaDataXrefContract row, SqlConnection connection, SqlTransaction transaction)
		{
			if(row == null) return 0;
			if(row.ElectionLevelMetaDataXrefId != null) return Update(row, connection, transaction);
		...
		/// <returns>The number of rows affected.</returns>
		public virtual int SaveAll(List<ElectionLevelMetaDataXrefContract> rows)
		{		
			var rowCount = 0;
			VotingInfoDb.ConnectThen(x => 
			{
		...
		/// <param name="transaction">The SqlTransaction to use</param>
		/// <returns>The number of rows affected.</returns>
		public virtual int SaveAll(List<ElectionLevelMetaDataXrefContract> rows, SqlConnection connection, SqlTransaction transaction)
		{
			var rowCount = 0;
