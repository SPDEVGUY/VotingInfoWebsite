...
None,
		...
		Client_Locations_Exists,
		Client_Locations_Search,
		Client_Locations_SelectAll,
		Client_Locations_SelectBy_LocationId,
		Client_Locations_SelectBy_ContentInspectionId,
		Client_Locations_SelectBy_ProposedByUserId,
		Client_Locations_SelectBy_ConfirmedByUserId,
    ...
    public abstract partial class AuthenticationBase
    {
        protected List<PermissionEnum> _readPermissions = new List<PermissionEnum> 
        {
			...
			PermissionEnum.Client_Locations_Exists,
			PermissionEnum.Client_Locations_Search,
			PermissionEnum.Client_Locations_SelectAll,
			PermissionEnum.Client_Locations_SelectBy_LocationId,
			PermissionEnum.Client_Locations_SelectBy_ContentInspectionId,
			PermissionEnum.Client_Locations_SelectBy_ProposedByUserId,
			PermissionEnum.Client_Locations_SelectBy_ConfirmedByUserId,
